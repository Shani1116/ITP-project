...
public class Member extends javax.swing.JInternalFrame {
   ...
   //create a Member object
    ...
    public void tableLoad(String key)
    {
        ...
        String q = "SELECT mid as MID,name as Name,NIC,l_no as Driver_License,phone as Phone_No,address as Address,vehilicense as Plate_No,vehicat as Category,package as Package FROM member WHERE vehilicense = '"+key+"' ";
    ...
    private void initComponents() {
        ...
        tablepb.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MID", "Name", "NIC", "Driver License", "Address", "Phone No.", "Plate No.", "Category", "Package"
            }
        ));
    ...
    private void tablepbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablepbMouseClicked
        ...
        int r = tablepb.getSelectedRow();
        
         String mid  = tablepb.getValueAt(r, 0).toString();
         String name = tablepb.getValueAt(r, 1).toString();
         String nic  = tablepb.getValueAt(r, 2).toString();
         String drili  = tablepb.getValueAt(r, 3).toString();
         String adr  = tablepb.getValueAt(r, 4).toString();
         String phn = tablepb.getValueAt(r, 5).toString();
         String pla = tablepb.getValueAt(r, 6).toString();
         String cat  = tablepb.getValueAt(r, 7).toString();
         String pac  = tablepb.getValueAt(r, 8).toString();
         ...
         inic.setText(nic);
         ilic.setText(drili);
         icat.setSelectedItem(cat);
         ipack.setSelectedItem(pac);
         iphn.setText(phn);
         iaddr.setText(adr);
         ivlice.setText(pla);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         iname.setText("K.K.Pathirana");
         inic.setText("896745342v");
         ilic.setText("4576234");
         iaddr.setText("175A,Kandy");
         iphn.setText("0713245654");
         ipack.setSelectedItem("Merchant");
         ivlice.setText("kn5678");
         icat.setSelectedItem("Car");//imid.setText("M003");
         iname.setText("K.K.Pathirana");
         inic.setText("896745342v");
         ilic.setText("4576234");
         iaddr.setText("175A,Kandy");
