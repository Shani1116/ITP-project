...
import static CarClasses.Arduino.updateSlotStatusExit;
import CarClasses.parkingVehicles;
import CarClasses.*;
...
public class Entrance extends javax.swing.JInternalFrame {
    ...
    public void QRcodee(String vno,String vehicat,String slotno) throws FileNotFoundException, IOException
    {
        ...
        String vehilic = this.convertVehiNo(vno);
        ...
        String details =vehilic+":"+vehicat+":"+slotno+":"+dat;
            ...
            File f = new File("D:\\ITP\\Yasith_BRo\\QRcodes\\"+QRnum+".png");
            ...
            jLabel1.setIcon(new ImageIcon("D:\\ITP\\Yasith_BRo\\QRcodes\\"+QRnum+".png"));
    ...
    public void printTicket(String Cashier,String date,String vehi,String cat,String  timeIn,String slot,String QRaddress )
    {
        try{
            Document doc = new Document();
                try{
                PdfWriter.getInstance(doc,new FileOutputStream(("D:\\ITP\\Yasith_BRo\\Tickets\\"+QRaddress+".pdf")));
                }
            ...
            wall1= Image.getInstance("D:\\ITP\\Yasith_BRo\\QRcodes\\"+QRaddress+".png");
       // wall2= ImageIO.read(new File("C:\\Users\\Yasith\\Desktop\\PicsArt_11-17-11.24.20.jpg"));
        ...
        if(slot.equals("F1A1")) type = "Floor 1 Block A Slot 1";
        else if(slot.equals("F1A2")) type = "Floor 1 Block A Slot 2";
        else if(slot.equals("F1A3")) type = "Floor 1 Block A Slot 3";
        else if(slot.equals("F1A4")) type = "Floor 1 Block A Slot 4";
        else if(slot.equals("F1A5")) type = "Floor 1 Block A Slot 5";
        else if(slot.equals("F1A6")) type = "Floor 1 Block A Slot 6";
        else if(slot.equals("F1B1")) type = "Floor 1 Block B Slot 1";
        else if(slot.equals("F1B2")) type = "Floor 1 Block B Slot 2";
        else if(slot.equals("F1B3")) type = "Floor 1 Block B Slot 3";
        else if(slot.equals("F1B4")) type = "Floor 1 Block B Slot 4";
        else if(slot.equals("F1B5")) type = "Floor 1 Block B Slot 5";
        else if(slot.equals("F1B6")) type = "Floor 1 Block B Slot 6";
           ...
           Paragraph p10 = new Paragraph(type);
