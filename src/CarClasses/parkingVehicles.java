...
public class parkingVehicles {
  ...
  //                      JOptionPane.showMessageDialog(null,"Problem with the Querry "+e);
    ...
    public Boolean isSuspend(String plateNo)
    {
        boolean rslt=false;
       // JOptionPane.showMessageDialog(null,plateNo+" hooooo");
        String q = "SELECT ticketno FROM parkingvehicle WHERE plateno ='"+plateNo+"' AND status != '"+"out"+"'";
