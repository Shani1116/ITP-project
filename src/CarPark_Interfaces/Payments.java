...
import Carpark_class.Paymentsc;
...
public class Payments extends javax.swing.JInternalFrame {
    ...
    public Payments() {
     ...
     public void tableLoad()
     {
            try 
            {
                String sql = "SELECT mid,name,NIC,vehilicense,vehicat,package,paystatus FROM member";
    ...
    private void initComponents() {
        ...
        paymentsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Membe rID", "Name", "NIC", "License NO", "Category", "Package", "Amount"
            }
        ));
